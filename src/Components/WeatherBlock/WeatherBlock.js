        ...
        <div onClick={onClick} className={`${styles.container} ${isCompact ? styles.isCompact:""}`} >
            ...
            <div className={styles.topSection}>
                ...
                <div className={styles.svgContainer}>
                    {weatherData.precipitation_description.includes("clear")  && <img src={Sun_SVG} className={styles.svgImg} alt="My SVG" />}
                    {weatherData.precipitation_description.includes("cloud") && <img src={Cloud_SVG} className={styles.svgImg} alt="My SVG" />}
                    {weatherData.precipitation_description.includes("wind") && <img src={Wind_SVG} className={styles.svgImg} alt="My SVG" />}
                    {weatherData.precipitation_description.includes("rain") && <img src={Rain_SVG} className={styles.svgImg} alt="My SVG" />}
